...
namespace AuthService.Application.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailVerificationAsync(string email, string administratorname, string token)
        {
        ...
        public async Task SendPasswordResetAsync(string email, string administratorname, string token)
        {
        ...
        public async Task SendWelcomeEmailAsync(string email, string administratorname)
        {
            var subject = "Welcome to AuthDotnet!";
     
            var body = $@"
                <h2>Welcome to AuthDotnet, {administratorname}!</h2>
        ...
        private async Task SendEmailAsync(string to, string subject, string body)
        {
            ...
            try
            {
                ...
                var administratorname = smtpSettings["Administratorname"];
                var password = smtpSettings["Password"];
                var fromEmail = smtpSettings["FromEmail"];
                var fromName = smtpSettings["FromName"];
     
                if (string.IsNullOrEmpty(host) || string.IsNullOrEmpty(administratorname) || string.IsNullOrEmpty(password))
                {
                ...
                try
                {
                    ...
                    // Autenticación
                    await client.AuthenticateAsync(administratorname, password);
